...
\usepackage[BSM, hion, jetetmiss,
  journal, math, misc, other, particle, process,
  unit,xref]{\ATLASLATEXPATH atlasphysics}
...
\verb|\PYTHIA{8}| to produce \PYTHIAV{8} or
\verb|\PYTHIA{8 (v8.160)}| to produce \PYTHIAV{8 (v8.160)}.
...
The definitions of \MeV, \GeV etc.\ in \texttt{atlasunit.sty} were updated in Version 01-08-00 in order to remove the \texttt{if} tests in them.
