...
symbol (\met{}) is defined there. A separate document~\cite{atlas-physics}
...
The Publication Committee provides a standard text giving a brief
description of the ATLAS detector, and the appropriate references.
