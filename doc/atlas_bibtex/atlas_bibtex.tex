...
while the traditional \BibTeX\ style files can be found in the directory \File{obsolete/bst} of the \Package{atlaslatex} package.
...
in the bibliography.
It is turned on by default for draft documents, as this is probably useful information.
For the final version it is turned off.
