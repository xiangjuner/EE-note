...
For Version 01-07-01 of \Package{atlaslatex}, CONF and PUB notes are available.
The list of ATLAS publications is complete and the titles have been checked.
However, quite a few of the more recent publication are missing the journal information.
This problem is being worked on and Inspire has been contacted.
