...
pdf\LaTeX\ will all references be correct. Unless you change a reference
you do not have to do the \texttt{bibtex/biber} step again.
...
\item Comments are not part of the bibliogrpahy databse format. Text outside entries will be ignored.
...
\item[015-01-30] Try to clarify nomenclature and what the recommended way to use \BibTeX\ proceed is.
\end{description}
