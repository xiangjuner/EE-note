...
\item[\Option{minbibnames=1}] specify the minimum number of author names before \enquote{et al.} is used, where the value is an integer;
...
\ADOCnew{15.0.0} The \Option{minbibnames} option was added as the Science Bulletin
...
\item[2024-02-19: Ian Brock] Add the \Option{minbibnames} option.
\end{description}
