...
As of Version 04-00-00 of \Package{atlaslatex} Errata for ATLAS publications are included.
...
\item LHC Collaboration~\cite{lhcCollaboration:2012}:
  \lstinputlisting[linerange=9-24]{atlas_bibtex.bib}
...
\item Other collaboration~\cite{otherCollaboration:2007}:
  \lstinputlisting[linerange=48-61]{atlas_bibtex.bib}
