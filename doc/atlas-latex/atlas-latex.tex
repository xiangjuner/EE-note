...
This collection ATLAS \LaTeX\ templates, style files and documentation 
replace and hopefully improve on the previous packages. They supersede:
\begin{itemize}
...
For each document that you create, you first unpack the latest version of
\texttt{atlaslatex} and then create your main document in the top-level directory.
...
\end{verbatim}
%
This command copies \texttt{atlas-document.tex} and {atlas-document-metadata.tex}
