...
\url{http://sourceforge.net/projects/biblatex-biber/} ad click your way through.
...
As you can see this is \enquote{Work in Progress!} More information will be added once more journal templates are tested.
...
As of \File{atlascover-01-00-00} the same macro names are used in both \Package{atlasdoc} and
