...
\item[\Option{texlive=YYYY} set if you use an older version of \TeX\ Live like 2009.
  ...
  Use options \Option{txfonts} and \Option{texlive=2013} to test options for arXiv submissions;
...
If for example you have \TeX\ Live 2009, add the option \Option{texlive=2013} to the document class.
...
You can use \Package{biber} instead by passing he option \Option{backend=biber} to \Package{atlaspackage}.
