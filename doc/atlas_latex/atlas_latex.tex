...
If for example you have \TeX\ Live 2009, include the package \Package{atlaspackage} with the option
\Option{texlive=2009}.
...
This is the default and can be set by passing he option \Option{backend=bibtex} to \Package{atlaspackage}.
