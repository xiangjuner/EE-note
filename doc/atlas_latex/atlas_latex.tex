...
See \cite{atlas-faq} for details on which collections are needed to get these packages
...
\Package{atlascover} and Package{atlascover} both needs \texttt{hyperref}. 
