...
As of Version 01-04-02, the date/time defintions in \File{atlasmisc.sty} have been commented out and the problem has disappeared again!
If for some reason you still get this error, try loading \Package{atlaspackage} with the option \Option{csquotes=off}.
