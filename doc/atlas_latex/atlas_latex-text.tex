...
\affil[b]{Another Institution}
    ...
    If you do not each institute on a separate line, uncomment the lines in the metadata file:
    \begin{verbatim}
\makeatletter
...
\makeatletter
\renewcommand*{\ADOC@docheadingdefault}{System Paper}
\renewcommand*{\AtlasDraftHeadingText}{DRAFT}
\makeatother
\end{verbatim}
