...
\item[\Option{mathlines={\normalfont true}|false}] put line numbers on equations;
...
You can set the option \Option{mathlines=true} to also number the lines in equations.
