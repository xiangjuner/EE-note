...
\begin{description}
  ...
  \ifthenelse{\AtlasTeXLiveVersion < 2016}{%
  ...
  \ifthenelse{\AtlasTeXLiveVersion < 2016}{XXX, while}{\(\int f(x) \dl2x\), while}\\
  \verb|\int f(x) \dl0x| or \verb|\int f(x) \dl x| gives  
  \ifthenelse{\AtlasTeXLiveVersion < 2016}{XXX.}{\(\int f(x) \dl0x\).}
