...
These should be collected in a file \File{mydocument-hepdata.tex},
which is included in the draft document during its circlation within ATLAS,
...
\begin{description}
  \item[\Macro{LEecomment}] adds a comment about a chnage, or suggested change.
\end{description}
...
Juan Pedro Araque has one most of the work setting up the PO-GitLab project.
