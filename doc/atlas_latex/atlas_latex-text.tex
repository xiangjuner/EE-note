...
If this causes problem, pass the option \Option{linenofix=false} to \Package{atlasdoc}.
For older versions,
...
\end{linenomath}
\end{verbatim}
If you are using \Package{linnomath} you may have to set the option \Option{mathlines=false}to avoid spurious line numbers.
