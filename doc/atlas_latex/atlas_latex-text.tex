...
I list a few here that are not included by \Package{atlaslatex},
...
As of Version 04-00-00 of \Package{atlaslatex}, the \File{Makefile} for \Package{atlaslatex} has been  restructured to reduce duplications and make separate comments for a new paper and a new note.
Errata are included in the ATLAS bibliography file.
Metadata for notes and papers are now separate temples to prepare for them being created directly from Glance.
This is the first version that is designed for the Glance/Git integration,
hence the jump in the main version number.
