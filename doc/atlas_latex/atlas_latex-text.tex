...
%-------------------------------------------------------------------------------
\section{\texttt{atlaslatex} and SVN}
\label{sec:svn}
%-------------------------------------------------------------------------------
...
\File{atlasltex-XX-YY-ZZ.tds.zip} file into your \File{texmf} tree -- see Section~\ref{sec:texmf}.
