...
%\end{verbatim}
%%
%By default, this will pass the option \Option{TDR} to \PackageP{atlasdoc}.
...
%\item[TDR] the document is book form like an LOI or TDR;
...
%The option \Option{TDR} uses book intead of article as the base class.
