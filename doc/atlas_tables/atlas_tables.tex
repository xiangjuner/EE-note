...
%-------------------------------------------------------------------------------
\documentclass[REPORT=false, UKenglish, texlive=2020]{atlasdoc}
...
Some tables include asymmetric uncertainites.
Those of you with sharp eyes may spot that the width of \enquote{\(+\)} and \enquote{\(-\)}
are different in the defaut font used by ATLAS (\Package{newtx}).
...
\begin{tcblisting}{}
  ...
  \begin{tabular}{cccc}
    \toprule
    No macro & \Macro{numpmerr} & \Macro{supsub} & \Macro{nnumpmerr} \\
    \midrule
    \(^{\num{+0.223}}_{\num{-0.123}}\) & \numpmerr{+0.223}{-0.123}{3} &
    \(\supsub{\num{+0.223}}{\num{-0.123}}\) & \nnumpmerr{+0.223}{-0.123}{3} \\
    \(^{\num{+0.284}}_{\num{-0.214}}\) \numpmerr{+0.284}{-0.214}{3} &
    \(\supsub{\num{+0.284}}{\num{-0.214}}\) & \nnumpmerr{+0.284}{-0.214}{3}
  \end{tabular}
\end{tcblisting}
% \end{table}
