...
\begin{description}
\item[xtab] the most modern package for tables that spread ove rmore than one page;
...
Typical definition can be found in the file \File{atlas\_tables-defs.sty}.
