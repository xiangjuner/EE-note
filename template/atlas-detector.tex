...
The ATLAS experiment~\cite{PERF-2007-01,Run3DetPaper} at the LHC is a multipurpose particle detector
...
The ATLAS detector~\cite{PERF-2007-01,Run3DetPaper} at the LHC covers nearly the entire solid angle around the collision point.\footnote{\AtlasCoordFootnote}
