...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ l | l | l}
    ...
    345124 & $H\to\tau\tau\to \mu\tau$          & \\ %$\pTX[][h1] > \SI{30}{\GeV}$ and $\pTX[][h2]    > \SI{20}{\GeV}$
    345125 & $H\to\tau\tau\to e \tau$           & \\ %$\pTX[][h1] > \SI{30}{\GeV}$ and $\pTX[][h2]    > \SI{20}{\GeV}$
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ l l l}
    ...
    346194 & $H\to\tau\tau\to e\tau$           & \\%$\pTX[][l1] > \SI{10}{\GeV}$ and $\pTX[][h1]    > \SI{20}{\GeV}$ \\
    346195 & $H\to\tau\tau\to \mu\tau$         & \\%$\pTX[][l1] > \SI{10}{\GeV}$ and $\pTX[][h1]    > \SI{20}{\GeV}$ \\
    \bottomrule
  \end{tabular}
\end{table}
