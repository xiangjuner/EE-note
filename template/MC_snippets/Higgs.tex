...
tune~\cite{STDM-2012-23}. A dipole-recoil strategy was used for the parton shower.%, which provides a better agreement than other recoil schemes with the NNLO predictions of proVBFH (not included in the HiggsReference twiki). % cite https://arxiv.org/pdf/1710.00391.pdf ?,
...
The prediction from the \POWHEG sample was normalised to the next-to-next-to-leading-order cross-section in QCD 
...
The predictions from \POWHEG were normalised to the best available theoretical prediction. The  $q\bar{q}/qg \to VH$ cross-sections
