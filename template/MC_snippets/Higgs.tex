...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ l | l | l}
    ...
    345124 & $H\to\tau\tau\to \mu\tau$      &\\ %$p_{\textrm T},h1 > \SI{30}{\GeV}$ and $p_{\textrm T},h2 > \SI{20}{GeV}$
    345125 & $H\to\tau\tau\to e \tau$      & \\ %$p_{\textrm T},h1 > \SI{30}{\GeV}$  and $p_{\textrm T},h2 > \SI{20}{\GeV}$
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!htbp]
  ...
  \begin{tabular}{ l l l}
    ...
    346194 & $H\to\tau\tau\to e\tau$      & \\%$p_{\textrm T},l1 > \SI{10}{\GeV}$  and $p_{\textrm T},h1 > \SI{20}{\GeV}$ \\
    346195 & $H\to\tau\tau\to \mu\tau$      & \\%$p_{\textrm T},l1 > \SI{10}{\GeV}$ and $p_{\textrm T},h1 > \SI{20}{\GeV}$ \\
    \bottomrule
  \end{tabular}
\end{table}
