...
%% \begin{table}[!htbp]
%% \begin{center}
%% \caption{Samples with \MGNLOPYTHIA[8] using CKKW-L merging} \label{tab:mg5-fxfx}
%% \begin{tabular}{ l | l }
%% \hline
%% DSID range & Description \\
%% \hline
...
%% 8\,\GeV\ with no restriction on the absolute value of the jet pseudorapity (jet $|\eta|$).
...
%% decribe the QED final state radiation, and the emission of lepton pairs is activated in this setup.
