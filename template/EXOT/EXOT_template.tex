...
\item \textit{Team overview task list including a list of all critical tasks, who is responsible for each task, and what else they are working on outside of this analysis}
