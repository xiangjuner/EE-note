...
% Title
\AtlasTitle{Bare bones ATLAS document}
...
% \AtlasCoverSupportingNote{A supporting note}       {\url{http://cds.cern.ch/XXXXXX}}
% \AtlasCoverSupportingNote{Another supporting note} {\url{http://cds.cern.ch/YYYYYY}}
